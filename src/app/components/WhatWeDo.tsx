...
const cards = [
  ...
  { title: "AI & Automation", description: "Custom AI agents, workflow automation, and ML models that eliminate repetitive tasks — with human oversight built into every workflow.", icon: Bot },
  { title: "Consulting & Training", description: "We upskill your team on every tool we build — workshops, documentation, and hands-on training so you never depend on us to operate what we deliver.", icon: BookOpen },
