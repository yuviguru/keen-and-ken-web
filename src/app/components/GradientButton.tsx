...
export default function GradientButton({
  ...
  const variants = {
    outline: `border border-white/20 bg-transparent text-white
      hover:border-[var(--accent-primary)]/60 hover:shadow-[0_0_24px_rgba(139,92,246,0.2)]
      active:scale-[0.97]`,
    filled: `border border-[var(--accent-primary)]/40 text-white
      bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-purple)]
